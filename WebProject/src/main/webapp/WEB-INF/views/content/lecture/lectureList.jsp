			...
			<table class="table" id="" align=center width=800>
				...
				<tr class="lectureList_content">
					...
					<td class="star_rating">
						<div data-productid="313" class="rateit" data-rateit-mode="font"
							data-rateit-value="2.4" data-rateit-readonly="true"
				...
				<tr>
					<td colspan="100%" style="text-align: right;">
						${page_index.countOfRow} 개의 결과가 검색 되었습니다.</td>
				</tr>
			</table>
		</div>
		<!-- master일 경우에만 보여줌 -->
		...
		<div class="container text-center">
			<ul class="pagination">
				<c:if test="${ page_index.currentPage>1}">
					<li><a
						href="lectureList.do?currentPage=${page_index.firstIndex}<c:if test='${not empty page_index.keyword}'>&search=${page_index.search}&keyword=${page_index.keyword}</c:if>">맨처음</a></li>
				</c:if>
